...
CoreGuard ships an on-device **Nemesis scanner** (a clandestine-spyware forensic
scanner) and a **spyware-domain blocker**, inspired by Amnesty International's
...
clandestine-spyware Indicators of Compromise (IOCs):
